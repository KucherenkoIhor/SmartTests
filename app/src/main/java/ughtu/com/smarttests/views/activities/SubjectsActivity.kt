...
class SubjectsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.setTitle(R.string.subjects)
        ...
        mAdapter.onItemClickListener = View.OnClickListener { view ->
            val holder = mRecyclerView.findContainingViewHolder(view) as SubjectsAdapter.SubjectsVieHolder?
            val subjectId = holder?.subject?.id ?: return@OnClickListener
            startActivity(LecturesActivity.newInstance(this, subjectId))
         }
